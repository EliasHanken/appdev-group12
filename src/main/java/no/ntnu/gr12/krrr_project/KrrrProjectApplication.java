...
//				.paths(PathSelectors.ant("/products/**"))
    ...
    private ApiInfo describeApi() {
        return new ApiInfo(
                "Appedev group12 backend for Bike Rental",
                "Spring boot backend for bike rental project (group12). Used in course IDATA2306 Application development",
                "1.0",
                "https://github.com/Streafe/appdev-group12.git",
                new Contact("Group12", null, null),
                "MIT License",
                null,
